...
export default function DashboardSmartAlerts({
  ...
  return (
    <div className="premium-panel mt-3 rounded-2xl p-3 transition-[border-color,background-color] duration-300 hover:border-cyan-200/18">
      ...
      <div className="mt-3 space-y-2">
        {smartAlerts.map((alert, index) => (
          <button
            ...
            className="w-full rounded-xl bg-white/5 p-2 text-left text-[11px] text-slate-300 transition-colors duration-200 hover:bg-white/[0.07]"
          >
            {alert}
          </button>
        ))}
