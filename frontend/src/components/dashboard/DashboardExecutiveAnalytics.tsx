      ...
      <div className="mt-3 grid gap-3 md:grid-cols-3">
        {["Ana", "Marco", "Bia"].map((seller) => {
          ...
          return (
            <div
              key={seller}
              className="rounded-xl border border-white/10 bg-black/20 p-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/[0.035]"
            >
