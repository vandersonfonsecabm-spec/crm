...
export default function DashboardMetrics({
  ...
  return (
    <DashboardMetricStrip
      metrics={[
        { label: "Pipeline total", value: money(analytics.totalValue), context: `Score médio ${analytics.averageScore}/100`, icon: <TrendingUp size={15} />, tone: "info", onClick: onOpenPipeline, actionLabel: "Negócios", featured: true },
