...
test("H5 apresenta cadastro, resumo e compras comprovadas do Cliente 360", async () => {
  ...
  for (const label of ["Cidade / UF", "CPF / CNPJ", "Pipeline ativo", "Negócios ativos", "Propostas abertas", "Compras anteriores comprovadas"]) {
...
test("H5 navega para contextos reais e nao inventa compras ou integracoes", async () => {
  ...
  assert.match(panel, /Nenhuma compra confirmada por Negócio fechado/);
