...
const relationSpecs = Object.freeze([
  ...
  ["commercial", "ItemPropostaComercial", "propostaId", "PropostaComercial"],
  ["commercial", "ItemPropostaComercial", "productOfferId", "ProductOffer"],
  ["commercial", "ItemPropostaComercial", "catalogProductId", "CommercialCatalogProduct"],
  ["commercial", "ItemPropostaComercial", "stockProductId", "ProdutoEstoque"],
  ["commercial", "HistoricoPropostaComercial", "propostaId", "PropostaComercial"],
  ["commercial", "HistoricoPropostaComercial", "autorId", "Usuario"],
  ["canonical-sale", "NegocioContratoVenda", "negocioId", "Negocio"],
  ["canonical-sale", "VendaCanonica", "clienteId", "Cliente"],
  ["canonical-sale", "VendaCanonica", "fechadoPorId", "Usuario"],
  ["canonical-sale", "VendaCanonica", "invalidadoPorId", "Usuario"],
  ["canonical-sale", "ItemVendaCanonica", "vendaId", "VendaCanonica"],
  ["canonical-sale", "HistoricoVendaCanonica", "negocioId", "Negocio"],
  ["canonical-sale", "HistoricoVendaCanonica", "autorId", "Usuario"],
